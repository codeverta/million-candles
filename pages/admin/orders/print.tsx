...
const PrintOrder = () => {
  ...
  const orderDetails = orderData.included.find(
    (item) => item.type === "order-details"
  );
            ...
            <tbody>
              <tr className="border-b border-gray-200">
                ...
                <td className="text-right py-1">
                  {orderDetails.attributes.qty}
                </td>
                <td className="text-right py-1">
                  {formatCurrency(orderDetails.attributes.price)}
                </td>
                <td className="text-right py-1">
                  {formatCurrency(
                    orderDetails.attributes.price * orderDetails.attributes.qty
                  )}
                </td>
              </tr>
            </tbody>
