...
const footerLinks = [
  {
    title: "Tentang Kami",
    links: [
      { name: "Profil Perusahaan", url: "/about" },
  ...
  },
  {
    title: "Bantuan",
    links: [
      { name: "Cara Pembelian", url: "/how-to-buy" },
      { name: "Pembayaran", url: "/payment" },
      { name: "Pengiriman", url: "/shipping" },
      { name: "Pengembalian", url: "/returns" },
      { name: "FAQ", url: "/faq" },
    ],
  },
  {
    ...
    links: [
      ...
      { name: "Kebijakan Pengiriman", url: "/shipping-policy" },
      { name: "Kebijakan Pengembalian", url: "/return-policy" },
    ],
  },
];
